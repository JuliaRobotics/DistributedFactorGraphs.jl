...
# GraphsDFG{T}(; kwargs...) where T <: AbstractParams = GraphsDFG{T,VariableCompute,DFGFactor}(;kwargs...)
function GraphsDFG{T}(
    g::FactorGraph{Int, VariableCompute, DFGFactor} = FactorGraph{Int, VariableCompute, DFGFactor}();
    kwargs...,
) where {T <: AbstractParams}
    return GraphsDFG{T, VariableCompute, DFGFactor}(g; kwargs...)
end
...
function GraphsDFG(
    ...
    return GraphsDFG{T, VariableCompute, DFGFactor}(g; solverParams, kwargs...)
end
...
function GraphsDFG(
    ...
    return GraphsDFG{typeof(solverParams), VariableCompute, DFGFactor}(
        FactorGraph{Int, VariableCompute, DFGFactor}();
        description,
        userLabel,
        robotLabel,
        sessionLabel,
