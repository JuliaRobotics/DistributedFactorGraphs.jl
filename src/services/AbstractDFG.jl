...
"""
function getVariables(dfg::G, regexFilter::Union{Nothing, Regex}=nothing; tags::Vector{Symbol}=Symbol[], solvable::Union{Nothing, Int}=nothing)::Vector{AbstractDFGVariable} where G <: AbstractDFG
...
ls
"""
function getVariableIds(dfg::G, regexFilter::Union{Nothing, Regex}=nothing; tags::Vector{Symbol}=Symbol[], solvable::Union{Nothing, Int}=nothing)::Vector{Symbol} where G <: AbstractDFG
...
Optionally specify a label regular expression to retrieves a subset of the variables.
"""
function ls(dfg::G, regexFilter::Union{Nothing, Regex}=nothing; tags::Vector{Symbol}=Symbol[], solvable::Union{Nothing, Int}=nothing)::Vector{Symbol} where G <: AbstractDFG
...
"""
function getFactors(dfg::G, regexFilter::Union{Nothing, Regex}=nothing; solvable::Union{Nothing, Int}=nothing)::Vector{AbstractDFGFactor} where G <: AbstractDFG
...
Optionally specify a label regular expression to retrieves a subset of the factors.
"""
function getFactorIds(dfg::G, regexFilter::Union{Nothing, Regex}=nothing; solvable::Union{Nothing, Int}=nothing)::Vector{Symbol} where G <: AbstractDFG
...
"""
# Alias
function lsf(dfg::G, regexFilter::Union{Nothing, Regex}=nothing; solvable::Union{Nothing, Int}=nothing)::Vector{Symbol} where G <: AbstractDFG
...
"""
function lsf(dfg::G, label::Symbol; solvable::Union{Nothing, Int}=nothing)::Vector{Symbol} where G <: AbstractDFG
...
"""
function getNeighbors(dfg::G, node::T; solvable::Union{Nothing, Int}=nothing, backendset::Union{Nothing, Int}=nothing)::Vector{Symbol}  where {G <: AbstractDFG, T <: DFGNode}
...
"""
function getNeighbors(dfg::G, label::Symbol; solvable::Union{Nothing, Int}=nothing, backendset::Union{Nothing, Int}=nothing)::Vector{Symbol} where G <: AbstractDFG
	error("getNeighbors not implemented for $(typeof(dfg))")
end
...
Retrieve a list of labels of the immediate neighbors around a given variable or factor.
"""
function ls(dfg::G, node::T; solvable::Union{Nothing, Int}=nothing)::Vector{Symbol} where {G <: AbstractDFG, T <: DFGNode}
...
Retrieve a list of labels of the immediate neighbors around a given variable or factor specified by its label.
"""
function ls(dfg::G, label::Symbol; solvable::Union{Nothing, Int}=nothing)::Vector{Symbol} where G <: AbstractDFG
    return getNeighbors(dfg, label, solvable=solvable)
end
...
"""
function getAdjacencyMatrix(dfg::AbstractDFG; solvable::Union{Nothing, Int}=nothing)::Matrix{Union{Nothing, Symbol}}
    #
...
"""
function getAdjacencyMatrixSparse(dfg::G; solvable::Union{Nothing, Int}=nothing)::Tuple{LightGraphs.SparseMatrixCSC, Vector{Symbol}, Vector{Symbol}} where G <: AbstractDFG
