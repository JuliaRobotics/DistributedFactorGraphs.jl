...
"""
    $(SIGNATURES)
Create a new CloudGraphs-based DFG factor graph.
"""
function CloudGraphsDFG(neo4jConnection::Neo4j.Connection, encodePackedTypeFunc, getPackedTypeFunc, decodePackedTypeFunc; description::String="CloudGraphs DFG", solverParams::Any=nothing, userId::String="", robotId::String="", sessionId::String="")
    ...
    CloudGraphsDFG(neo4jInstance, description, encodePackedTypeFunc, getPackedTypeFunc, decodePackedTypeFunc, Dict{Symbol, Int64}(), Dict{Symbol, DFGVariable}(), Dict{Symbol, DFGFactor}(), userId, robotId, sessionId, Symbol[], solverParams)
end
# Accessors
