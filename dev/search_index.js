...
{
    "location": "func_ref/#DistributedFactorGraphs.addVariable!",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.addFactor!",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.getVariables",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.getFactors",
    "page": "Reference",
    "title": "DistributedFactorGraphs.getFactors",
    "category": "function",
    "text": "List the DFGFactors in the DFG. Optionally specify a label regular expression to retrieves a subset of the factors.\n\n\n\n\n\ngetFactors(dfg)\ngetFactors(dfg, regexFilter)\n\n\nList the DFGFactors in the DFG. Optionally specify a label regular expression to retrieves a subset of the factors.\n\n\n\n\n\ngetFactors(dfg)\ngetFactors(dfg, regexFilter)\n\n\nList the DFGFactors in the DFG. Optionally specify a label regular expression to retrieves a subset of the factors.\n\n\n\n\n\ngetFactors(dfg)\ngetFactors(dfg, regexFilter)\n\n\nList the DFGFactors in the DFG. Optionally specify a label regular expression to retrieves a subset of the factors.\n\n\n\n\n\ngetFactors(dfg)\ngetFactors(dfg, regexFilter)\n\n\nList the DFGFactors in the DFG. Optionally specify a label regular expression to retrieves a subset of the factors.\n\n\n\n\n\ngetFactors(dfg)\ngetFactors(dfg, regexFilter)\n\n\nList the DFGFactors in the DFG. Optionally specify a label regular expression to retrieves a subset of the factors.\n\n\n\n\n\n"
},

{
    "location": "func_ref/#DistributedFactorGraphs.getVariable",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.getFactor",
    "page": "Reference",
    "title": "DistributedFactorGraphs.getFactor",
    "category": "function",
    "text": "Get a DFGFactor from a DFG using its underlying integer ID.\n\n\n\n\n\nGet a DFGFactor from a DFG using its label.\n\n\n\n\n\ngetFactor(dfg, factorId)\n\n\nGet a DFGFactor from a DFG using its underlying integer ID.\n\n\n\n\n\ngetFactor(dfg, label)\n\n\nGet a DFGFactor from a DFG using its label.\n\n\n\n\n\ngetFactor(dfg, factorId)\n\n\nGet a DFGFactor from a DFG using its underlying integer ID.\n\n\n\n\n\ngetFactor(dfg, label)\n\n\nGet a DFGFactor from a DFG using its label.\n\n\n\n\n\ngetFactor(dfg, factorId)\n\n\nGet a DFGFactor from a DFG using its underlying integer ID.\n\n\n\n\n\ngetFactor(dfg, label)\n\n\nGet a DFGFactor from a DFG using its label.\n\n\n\n\n\ngetFactor(dfg, label)\n\n\nGet a DFGFactor from a DFG using its label.\n\n\n\n\n\ngetFactor(dfg, label)\n\n\nGet a DFGFactor from a DFG using its label.\n\n\n\n\n\n"
},

{
    "location": "func_ref/#DistributedFactorGraphs.getNeighbors",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.ls",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.lsf",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.updateVariable!",
    "page": "Reference",
    "title": "DistributedFactorGraphs.updateVariable!",
    "category": "function",
    "text": "Update a complete DFGVariable in the DFG.\n\n\n\n\n\nupdateVariable!(dfg, variable)\n\n\nUpdate a complete DFGVariable in the DFG.\n\n\n\n\n\nupdateVariable!(dfg, variable)\n\n\nUpdate a complete DFGVariable in the DFG.\n\n\n\n\n\nupdateVariable!(dfg, variable)\n\n\nUpdate a complete DFGVariable in the DFG.\n\n\n\n\n\nupdateVariable!(dfg, variable)\n\n\nUpdate a complete DFGVariable in the DFG.\n\n\n\n\n\nupdateVariable!(dfg, variable)\n\n\nUpdate a complete DFGVariable in the DFG.\n\n\n\n\n\n"
},

{
    "location": "func_ref/#DistributedFactorGraphs.updateFactor!",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.deleteVariable!",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.deleteFactor!",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.isFullyConnected",
    "page": "Reference",
    "title": "DistributedFactorGraphs.isFullyConnected",
    "category": "function",
    "text": "Checks if the graph is fully connected, returns true if so.\n\n\n\n\n\nisFullyConnected(dfg)\n\n\nChecks if the graph is fully connected, returns true if so.\n\n\n\n\n\nisFullyConnected(dfg)\n\n\nChecks if the graph is fully connected, returns true if so.\n\n\n\n\n\nisFullyConnected(dfg)\n\n\nChecks if the graph is fully connected, returns true if so.\n\n\n\n\n\nisFullyConnected(dfg)\n\n\nChecks if the graph is fully connected, returns true if so.\n\n\n\n\n\nisFullyConnected(dfg)\n\n\nChecks if the graph is fully connected, returns true if so.\n\n\n\n\n\n"
},

{
    "location": "func_ref/#DistributedFactorGraphs.hasOrphans",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.getSubgraphAroundNode",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.getSubgraph",
    "page": "Reference",
...
{
    "location": "func_ref/#DistributedFactorGraphs.getSummary",
    "page": "Reference",
    "title": "DistributedFactorGraphs.getSummary",
    "category": "function",
    "text": "Get a summary of the graph (first-class citizens of variables and factors). Returns a AbstractDFGSummary.\n\n\n\n\n\n"
},

{
    "location": "func_ref/#DistributedFactorGraphs.getSummaryGraph",
    "page": "Reference",
    "title": "DistributedFactorGraphs.getSummaryGraph",
    "category": "function",
    "text": "Get a summary graph (first-class citizens of variables and factors) with the same structure as the original graph. Note this is a copy of the original. Returns a LightDFG{NoSolverParams, DFGVariableSummary, DFGFactorSummary}.\n\n\n\n\n\n"
},

{
    "location": "func_ref/#Summaries-1",
    "page": "Reference",
    "title": "Summaries",
    "category": "section",
    "text": "getSummary\ngetSummaryGraph"
...
{
    "location": "func_ref/#Visualization-and-Plotting-1",
    "page": "Reference",
